...
//
//  Created by SOURABH BANEJEE 12. 8. 31..
...
- (void)reloadAddressBook
{
    ...
    if (_group) {
        ...
        self.title = NSLocalizedString(@"Invite People", nil);
...
- (void)viewDidLoad
{
    ...
    [app.appDel_DicForEvent setObject:@"" forKey:@"ContactName"];
...
- (IBAction)doneAction:(id)sender
{
    ...
    [app.appDel_DicForEvent setObject:objects forKey:@"ContactName"];
        ...
        ///////////////////////////CREATE TAB 1/////////////////////
        SelectRestaurantVC *viewController_rest=[newStoryBoard instantiateViewControllerWithIdentifier:@"SelectRestaurantVC"];
        [self.navigationController pushViewController:viewController_rest animated:YES];
